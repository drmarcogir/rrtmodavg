...
(Burnham & Anderson 2003) and Cade (2015). Firsta a 95% confidence set of models selected by starting with the 
models with the highest weight (Akaike or BIC weight) and adding to the model with the
...
explanatory variable (Burnham & Anderson 2003) or the average as the ratio of absolute values of the t statistics 
for unstandardized predictors where weights are model weights Cade (2015).
